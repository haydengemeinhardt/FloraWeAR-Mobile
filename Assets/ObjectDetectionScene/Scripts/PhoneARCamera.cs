...
public class PhoneARCamera : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        m_DistanceFromCamera = new Vector3(Camera.main.transform.position.x, Camera.main.transform.position.y-1, Camera.main.transform.position.z-1);
    ...
    private void DrawBoxOutline(BoundingBox outline, float scaleFactor, float shiftX, float shiftY)
    {
        ...
        //for(int i = -2; i<=2; i++)
        //{
        Ray ray = arCam.ScreenPointToRay(new Vector3(x, y, 0));
        //RaycastHit hit;
        float enter = 0.0f;
        ...
        { 
            ...
            Character.transform.position = hitPoint;
            Character.transform.LookAt(Camera.main.transform, Vector3.up);
            //spawnFarmChar()
            //i=3;
            temp2 = 1;
        }
        ...
        if (temp2 == 0)
        {
            Debug.Log("temp2 = 0");
            Character.SetActive(true);
            Character.transform.position =  m_DistanceFromCamera;//new Vector3(Camera.main.transform.position.x, Camera.main.transform.position.y / 2, Camera.main.transform.position.z);
            Character.transform.LookAt(Camera.main.transform, Vector3.up);
        }
        else if (temp2 == 1)
        {
        ...
        // Debug.Log("Draw");
        // spawnedObject = GameObject.Find("Character-FarmWear(Clone)");
        // Debug.Log("Destry");
        // Destroy(spawnedObject);
        // Debug.Log("spawn?");
        // var spawnPosition = new Vector3(1, 1, 1);
        // ARPlane arPlane = args.added[0];
        // spawnedObject = Instantiate(spawnablePrefab, arPlane.transform.position, Quaternion.identity); 
        //arPlaneManager = GetComponent<ARPlaneManager>();
        //arPlaneManager.planesChanged += PlaneChanged;
        //temp2 = 1;
        //Debug.Log("spawned!");
    ...
    private void spawnFarmChar(float x, float y)
    {
        Character.SetActive(true);
        // Character.transform.position = arPlane.transform.position;//new Vector3(0,0,0);
    ...
    //     if (temp2 == 0 || temp2 == 1)
    //     {
    //         if(args.added != null) //&& spawnedObject == null)
    //         {
    //             //spawnedObject = GameObject.Find("Character-FarmWear(Clone)");
    //             //Debug.Log("Destroy");
    //             //Destroy(spawnedObject);
    //             Debug.Log("planes found1!");
    //             //ARPlane arPlane = args.added[0];
    ...
    //             // { 
    //             //     Debug.Log("Hit99!");
    //             //     //Debug.Log(ray.pose.position)
    //             // }
    //             // else
    //             // {
    //             //     Debug.Log("no planes hit!");
    //             // }
    //             //Debug.Log("planes found2!");
    //             //spawnedObject = Instantiate(spawnablePrefab, arPlane.transform.position, Quaternion.identity);
    //             //Debug.Log("planes found3!"); 
    //             //spawnablePrefab.transform.
    //             //Debug.Log(Character.transform.position);
    //             // Character.SetActive(true);
    //             // Character.transform.position = arPlane.transform.position;//new Vector3(0,0,0);
    //             // Character.transform.LookAt(Camera.main.transform);
    //             // Debug.Log(Character.transform.position);
    //             // Debug.Log("planes found4!"); 
    //             //temp2 = 0;
    //         }
    //         else
    //         {
