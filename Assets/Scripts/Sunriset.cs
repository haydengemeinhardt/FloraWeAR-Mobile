...
public sealed class Sunriset
{
	...
	public static void SunriseSunset(DateTime dateTime, double lat, double lng, out DateTime sunrise, out DateTime sunset) {
		SunriseSunset(dateTime.Year, dateTime.Month, dateTime.Day, lat, lng, out double tsunrise, out double tsunset);

		sunrise = new DateTime(dateTime.Year, dateTime.Month, dateTime.Day);
		sunrise = sunrise.AddHours(tsunrise);

		sunset = new DateTime(dateTime.Year, dateTime.Month, dateTime.Day);
		sunset = sunset.AddHours(tsunset);
	}
